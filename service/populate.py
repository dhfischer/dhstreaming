...
Movie.objects.create(
    ...
    age_rating='16+',  # Classificação etária
    cast='Nome do Ator, Outro Ator',  # Elenco (pode ser uma lista de nomes)
    director='Nome do Diretor',  # Diretor
    genre='Ação, Drama',  # Gênero (pode ser uma lista de gêneros)
    release_date=date(2023, 9, 15)  # Data de lançamento
)
Movie.objects.create(
    title='The Godfather',
    year=1972,
